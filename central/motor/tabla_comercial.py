...
from .comparativos import GRIS, IGUAL, SIMBOLOS, SIN_DATO, SUBE, BAJA, VERDE, ROJO, UMBRAL_IGUAL, Variacion, variacion
...
def _comparar(ind: Indicador, actual, base) -> Variacion:
...
def construir_tabla(actual: Metricas, anterior: Metricas | None, anio_anterior: Metricas | None) -> list[Fila]:
    ...
    for ind in INDICADORES:
        ...
        filas.append(Fila(ind, a, p, _comparar(ind, a, p), y, _comparar(ind, a, y)))
    return filas
